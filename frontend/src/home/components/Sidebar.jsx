        ...
        <div className='h-full w-auto px-1'>
            ...
            {searchUser?.length > 0 ? (
                ...
                <>
                    ...
                    <div className='mt-auto px-1 py-1 flex'>
                        <button onClick={handelLogOut} className='hover:bg-red-600  bg-red-400 w-10 cursor-pointer hover:text-white rounded-lg'>
                            <BiLogOut size={25} />
                        </button>
                        <p className='text-sm py-1 px-1 text-red-400'> Logout</p>
                    </div>
                </>
            )}
        </div>
